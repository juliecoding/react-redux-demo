//This is a reducer file, in projects we're going to call it a duck (re-ducks, get it?!)
...
const { UPDATE_NAME, ADD_PERSON, UPDATE_EXCITEMENT_LEVEL, GET_PEOPLE } = ActionConstants
